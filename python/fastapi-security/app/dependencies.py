...
fake_users_db = {
    "johndoe": {
        ...
        "hashed_password": "$2b$12$DprlrXfhcFhB.7sVzuF3yeT3fG7jLrHQ4RS0rHxxE2EZ6f0yQ1gKC",
        "disabled": False,
    }
}
...
async def get_query_token(token: str):
    if token != "bee3e447bda8ad7d8f3bbab3e5c42018":
        raise HTTPException(
            status_code=400, detail="No valid token provided")
