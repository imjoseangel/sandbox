...
def main():
    ...
    # Connect to localhost:5672 as user with the password password and virtual host "/" (%2F)
    example = ExamplePublisher(
        'amqp://user:password@localhost:5672/%2F?connection_attempts=3&heartbeat=3600'
    )
    example.run()
